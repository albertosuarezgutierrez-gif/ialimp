...
- Storage: buckets `cleaning-photos` (**PRIVADO**; TTL 5 días), `propuestas-leads`, `cvs-rrhh`, `property-access-files`, `documentos-contables` (justificantes de apuntes; público, path `{empresa_id}/{id}/...`).
